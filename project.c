...
int main()
{
  Gpio_setup();
	...
	while (1)
	{
		...
		PWMPulseWidthSet(PWM1_BASE, PWM_OUT_2, 450);
    PWMPulseWidthSet(PWM1_BASE, PWM_OUT_3, 450); 
...
//MIGHT NEED A DELAY HERE?			
    ...
    PWMPulseWidthSet(PWM1_BASE, PWM_OUT_1, 0); 	
		...
		GPIOPinWrite(GPIO_PORTF_BASE,GPIO_PIN_3, 0);
		GPIOPinWrite(GPIO_PORTF_BASE,GPIO_PIN_1, 0);
		PWMPulseWidthSet(PWM1_BASE, PWM_OUT_0, 450);
    PWMPulseWidthSet(PWM1_BASE, PWM_OUT_1, 450); 
